function scr_pause_background(){
	...
	layer_hspeed(lay_0, 0);
	layer_hspeed(lay_1, 0);
	layer_hspeed(lay_2, 0);
	layer_hspeed(lay_3, 0);
	layer_hspeed(lay_4, 0);
	layer_hspeed(lay_5, 0);
	layer_hspeed(lay_6, 0);
	layer_hspeed(lay_7, 0);
	layer_hspeed(lay_8, 0);
	layer_hspeed(lay_9, 0);
