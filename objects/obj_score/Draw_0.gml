...
draw_text_color(room_width/2 - stringwidth/2, room_height/2 - 150, text, c_yellow, c_yellow, c_yellow, c_yellow, 1);
...
draw_text_color(room_width/2 - string_width(comebackmenu)/2, room_height/2 + 110, comebackmenu, c_yellow, c_yellow, c_yellow, c_yellow, 1);
